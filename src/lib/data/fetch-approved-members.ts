...
const SELECT =
  'id, slug, name, website, department, batch, roles, interests, profile_pic, instagram, twitter, linkedin, github, connections, created_at, updated_at, is_approved' as const;
