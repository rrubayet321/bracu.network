...
// Inline SVG icons — avoids lucide brand icon naming issues across versions
const GlobeIcon = () => (
...
export default function SocialIcons({ member }: SocialIconsProps) {
  const links = [
    { href: member.website,   icon: <GlobeIcon />,     label: 'website' },
    { href: member.github,    icon: <GitHubIcon />,    label: 'github' },
    { href: member.linkedin,  icon: <LinkedInIcon />,  label: 'linkedin' },
    { href: member.twitter,   icon: <XIcon />,         label: 'twitter' },
